...
- (void)application:(UIApplication *)application handleWatchKitExtensionRequest:(NSDictionary *)userInfo reply:(void (^)(NSDictionary *))reply{
    ...
    UIAlertView *theAlert=[[UIAlertView alloc]initWithTitle:@"Wow" message:@"Here we Goo" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [theAlert show];
    
    if ([[userInfo objectForKey:@"request"] isEqualToString:@"catch"]) {
        
    
        
        NSDictionary *response = [NSDictionary dictionaryWithObject:@"Opened App" forKey:@"open"];
        reply(response);
    }
...
- (NSURL *)applicationDocumentsDirectory
{
    ...
    NSURL *sharedContainerURL= [[NSFileManager defaultManager]containerURLForSecurityApplicationGroupIdentifier:@"group.com.techendeavour.watchkit"];
